    ...
    <section class="values-section">
            ...
            <div class="values-grid">
                <div class="value-item">
                    ...
                    <p>Lors de leur entrée au sein de notre service, chaque jeune présente des compétences, des ressources, mais également des fragilités, </p>
                </div>
                <div class="value-item">
                    ...
                    <p>Pour évoluer positivement, tout individu a besoin de développer un réseau social proche de son modèle éducatif. Pendant la durée de la prise en charge,</p>
                </div>
                <div class="value-item">
                    ...
                    <p>Nous souhaitons à chaque jeune pris en charge d’évoluer, de grandir et pour ce faire nous mettons l’accent sur la responsabilisation face à ses actes</p>
                </div>
                <div class="value-item">
                    <h4>L'autonomie</h4>
                    <svg class="valeur-underline"  xmlns="http://www.w3.org/2000/svg" width="166" height="12" viewBox="0 0 166 12" fill="none">
                    ...
                    <p>L’enfant, le jeune est un individu qui se construit en fonction de son vécu, de
                        ses expériences personnelles afin de développer ses compétences propres.</p>
                </div>
            </div>
    </section>
   ...
   <section class="journey-section">
    <div class="morning-section">
        <div class="morning-content">
            ...
            <p>v,rjtogntt,grenvcfervnuvnnirozmgnresjfvnrltgnrjsnv:</p>
        </div>
        <div class="soleil">
