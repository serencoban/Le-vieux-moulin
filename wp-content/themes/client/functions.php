...
function enqueue_assets_from_vite_manifest(): void
{
  ...
  if (file_exists($manifestPath)) {
    ...
    if (isset($manifest['wp-content/themes/client/resources/js/main.js'])) {
      wp_enqueue_script('client', get_theme_file_uri('public/' . $manifest['wp-content/themes/client/resources/js/main.js']['file']), [], null, true);
    }

    // Vérifier et ajouter le fichier CSS
    if (isset($manifest['wp-content/themes/client/resources/css/styles.scss'])) {
      wp_enqueue_style('client', get_theme_file_uri('public/' . $manifest['wp-content/themes/client/resources/css/styles.scss']['file']));
    }
  }
}
...
function dw_asset(string $file): string
{
  ...
  if (file_exists($manifestPath)) {
    ...
    if (isset($manifest['wp-content/themes/client/resources/js/main.js']) && $file === 'js') {
      return get_theme_file_uri('public/' . $manifest['wp-content/themes/client/resources/js/main.js']['file']);
    }

    if (isset($manifest['wp-content/themes/client/resources/css/styles.scss']) && $file === 'css') {
      return get_theme_file_uri('public/' . $manifest['wp-content/themes/client/resources/css/styles.scss']['file']);
    }
  }
...
add_theme_support('post-thumbnails', ['foyers']);
...
function dw_handle_contact_form()
{
    $form = (new \DW_Theme\Forms\ContactForm())
        ...
        ->sanitize('objet', 'sanitize_text_field')
        ->sanitize('description', 'sanitize_textarea_field');
