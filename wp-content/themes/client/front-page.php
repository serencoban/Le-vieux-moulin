...
<?php get_header(); ?>
    <section class="header">
        <div class="header_container">
            <h2 itemprop="name" role="heading" class="main_title"><?php echo get_field('vm_title') ?></h2>
            <div class="underline" aria-hidden="true">
                <svg class="draw-path" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 510 18" aria-hidden="true" focusable="false">
    ...
    <section class="maisons_container" itemscope itemtype="https://schema.org/House">
        ...
        <div class="maisons_cards">
            <div class="maison vm">
                ...
                <span itemprop="name">Le Vieux Moulin</span>
                <a href="<?php echo get_permalink(get_page_by_path('nos-foyers')) ?>#vm-foyer" aria-label="Découvrir le Vieux Moulin" title="Découvrir le Vieux Moulin">
                    <?php
                    $image = get_field('vm');
                    if ($image) {
            ...
            <div class="maison edelweiss">
                ...
                <a href="<?php echo get_permalink(get_page_by_path('nos-foyers')) ?>#edelweiss-foyer" aria-label="Découvrir Edelweiss" title="Découvrir Edelweiss">
                    <?php
    ...
    <section class="valeur-container" itemscope="" itemtype="https://schema.org/Service">
        ...
        <div class="accueil-cards">
                ...
                <div class="card-header">
                    ...
                    if ($icon) {
                        echo wp_get_attachment_image($icon['ID'], 'thumbnail', false, [
                            ...
                            'class' => 'icon',
                            'srcset' => wp_get_attachment_image_srcset($icon['ID'], 'thumbnail'),
                            'sizes' => '(max-width: 768px) 60px, 80px'
                        ]);
                    } ?>
                    <h3 itemprop="name" class="highlight-title">Matériel</h3>
                </div>
            ...
            <div class="accueil-card">
                <div class="card-header">
                    ...
                    <h3 itemprop="name" class="highlight-title">Educatif</h3>
                </div>
            ...
            <div class="accueil-card">
                <div class="card-header">
                    ...
                    <h3 itemprop="name" class="highlight-title">Psychologique</h3>
                </div>
    ...
    <section class="projet-container">
        <div class="projets-grid">
            <div class="projets-header from-left">
                ...
                <a class="btn" href="<?php echo get_permalink(61); ?>" title="Découvrez tous nos projets" aria-label="Découvrez tous nos projets">Découvrez tous nos projets</a>
            </div>
            <?php
            $args = [
                'post_type' => 'projets',
            ...
            if ($projets_query->have_posts()) :
                while ($projets_query->have_posts()) : $projets_query->the_post();
                    ...
                    ?>
                    <article itemscope itemtype="https://schema.org/CreativeWork" <?php post_class('mini_desc_projet'); ?>>
                        <a href="<?php the_permalink(); ?>" title="Aller vers le projet" itemprop="url">
                            <div class="projet-div-cont">
                                <div class="projet-title">
                                    <h3 itemprop="headline"><?php the_title(); ?></h3>
                                    <p itemprop="description"><?php echo get_field('mini_desc_projet')?></p>
                                </div>
                                <?php if ($image): ?>
                                    <figure itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
                                        <img
                                                src="<?= esc_url($image['sizes']['large']); ?>"
                                                srcset="<?= esc_attr(wp_get_attachment_image_srcset($image['ID'], 'large')); ?>"
                                                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                                                alt="<?= esc_attr($image['alt']); ?>"
                                                class="project_img"
                                        />
                                        <meta itemprop="url" content="<?= esc_url($image['url']); ?>" />
                                        <meta itemprop="width" content="<?= esc_attr($image['width']); ?>" />
                                        <meta itemprop="height" content="<?= esc_attr($image['height']); ?>" />
                                    </figure>
                                <?php endif; ?>
                                <div class="voir-plus">
                                    <svg class="arrow-icon" xmlns="http://www.w3.org/2000/svg" width="25" height="16" viewBox="0 0 25 16" fill="none" aria-hidden="true" focusable="false">
    ...
    <section class="news">
            ...
            <div class="news-div">
                ...
                if ($recent_post->have_posts()) :
                    while ($recent_post->have_posts()) : $recent_post->the_post(); ?>
                        <div class="news_post" itemscope itemtype="https://schema.org/NewsArticle">
                            <div class="date-ctn">
                                <h3 itemprop="headline"><?php the_title(); ?></h3>
                                <span itemprop="datePublished" class="actu-date"><?php echo get_the_date('d/m/Y'); ?></span>
                            </div>
                            <p itemprop="description"><?php echo get_field('actu-description')?></p>
                        </div>
                    <?php endwhile;
                    wp_reset_postdata();
                else : ?>
        ...
        <div class="moulin">
            <svg class="moulin-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160.356 252.646" width="300" height="300" aria-hidden="true" focusable="false">
                <g id="uuid-0830fc4c-5524-46f1-a886-19f9d4fda351">
                    <path d="M30.789,103.526L2.981,225.419c-2.675,11.728,6.139,22.938,18.167,23.104l117.541,1.621c11.698.161,20.731-10.235,18.939-21.796l-19.828-127.875c-1.497-9.654-10.104-16.577-19.855-15.968l-69.905,4.361c-8.365.522-15.387,6.49-17.251,14.661Z" />
                    <path d="M73.425,11.605L11.701,77.998c-5.796,6.234-1.095,15.995,7.704,15.995h126.402c9.786,0,15.026-10.846,8.596-17.793L94.644,11.627c-5.606-6.057-15.598-6.068-21.218-.022Z" />
                    <ellipse cx="62.711" cy="155.167" rx="15.223" ry="21.372"/>
                    <ellipse cx="102.702" cy="155.167" rx="15.223" ry="21.372"/>
                    <ellipse cx="59.098" cy="149.049" rx="7.226" ry="8.43" />
                    <ellipse cx="65.522" cy="161.605" rx="3.613" ry="4.215" />
                    <ellipse cx="101.296" cy="148.171" rx="7.226" ry="8.43" />
                    <ellipse cx="107.72" cy="160.728" rx="3.613" ry="4.215" />
                    <path d="M72.007,185.346s7.355,10.589,20.283.746"/>
                </g>
                <g id="uuid-7961b3a0-38d8-496c-a583-1333ef75db81">
                    <path d="M87.851,54.995S130.516,4.928,134.435,4.928s24.816,24.38,22.639,27.428c-2.177,3.048-58.58,37.006-58.58,37.006" />
                    <path d="M77.934,83.729s-42.665,50.066-46.584,50.066-24.816-24.38-22.639-27.428c2.177-3.048,58.58-37.006,58.58-37.006"/>
                    <path d="M79.966,52.566S37.301,2.5,33.383,2.5,8.567,26.88,10.744,29.928c2.177,3.048,58.58,37.006,58.58,37.006"/>
                    <path d="M99.405,71.261s54.252,37.198,54.662,41.095-21.653,27.228-24.911,25.382c-3.258-1.846-42.926-54.391-42.926-54.391" />
                    <circle cx="83.061" cy="68.411" r="15.02"/>
                </g>
            </svg>
        </div>
    </section>
<section class="faq-section" itemscope="" itemtype="https://schema.org/FAQPage">
    <div class="faq-header">
        ...
        <svg class="wave-svg" xmlns="http://www.w3.org/2000/svg" width="510" height="18" viewBox="0 0 510 18" aria-hidden="true" focusable="false">
            <path d="M2 8.33118C10.1432 3.64392 31.8042 -2.9986 53.3024 7.92942C74.8005 18.8574 92.1863 12.7506 98.1919 8.33114C108.575 4.04564 131.966 -2.03441 142.471 7.92937C152.976 17.8932 175.96 13.5541 186.139 10.1391C193.264 5.71966 211.362 -0.708581 226.753 8.93379C242.144 18.5762 267.368 12.5497 278.056 8.33114C289.558 3.71084 315.189 -2.75758 325.693 8.33114C336.198 19.4199 358.572 14.1567 368.445 10.1391C376.181 5.18398 395.99 -1.8737 413.335 9.53644C430.68 20.9466 452.524 14.6924 461.278 10.1391C469.625 6.18839 490.655 0.777951 508 10.7417"/>
        </svg>
    </div>
